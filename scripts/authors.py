...
# —— 个人认证（红V/橙V/金V）：先看博主类标识，再看媒体类标识 ——
BLOGGER_KW = ["博主", "创作者", "作者", "达人", "大V", "观察官", "自媒体"]
MEDIA_PERSON_KW = ["日报", "晚报", "时报", "早报", "新闻", "电视台", "频道", "广播", "传媒",
                   "周刊", "资讯", "官方微博", "媒体", "网", "报"]
...
def enrich(a):
    ...
    if verify == "蓝V":
        ...
        if any(k in raw for k in BLOGGER_KW):
            ident = "认证博主"
        elif any(k in raw for k in MEDIA_PERSON_KW):
            ident = "媒体人"
        else:
            ident = "认证博主"
    else:
